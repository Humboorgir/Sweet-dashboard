...
const blockLinks = () => {
  ...
  return (
    ...
    flex flex-col mb-4 mr-3">
      <h4 className="font-bold text-lg tracking-tight text-gradient mb-0.5">Anti Spam</h4>
      <p className="text-foreground-soft text-sm">Deletes messages if they are detected to be spammed</p>
      <Switch
        className="mt-auto"
        size="sm"
