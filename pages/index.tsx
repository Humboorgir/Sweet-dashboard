...
const Page = () => {
  ...
  return (
    <>
      {/* metadata   */}
      <Head>
        <title>Sweet - Next Generation Moderation</title>

        <meta
          name="description"
          content="Next Generation Discord Moderation Bot That Takes Advantage of Artificial Intelligence to Enhance Your Experience."
        />
      </Head>
