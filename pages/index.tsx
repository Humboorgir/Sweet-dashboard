        ...
        {features.map((feature, i) => {
          return (
            <div
              ...
              <div className="ml-12 md:ml-0 mb-8 md:mb-0 col-start-1 col-end-1 group-even:col-start-2 group-even:col-end-2">
              ...
              <Image
                className="ml-2 z-10 max-w-[70vw] md:col-start-2 md:col-end-2
